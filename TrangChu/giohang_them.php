<?php
    ...
    $sql_check = "SELECT * FROM `giohang` WHERE MaNguoiDung = '$mand' AND MaDS = '$mads'";
    ...
    if ($result_check->num_rows > 0) {
        ...
        $sql_update = "UPDATE giohang SET SoLuong = '$new_quantity' WHERE MaNguoiDung = '$mand' AND MaDS = '$mads'";
        ...
        $sql_addgiohang = "INSERT INTO `giohang`(`MaNguoiDung`, `MaDS`, SoLuong) VALUES
                        ('$mand', '$mads', 1)";
