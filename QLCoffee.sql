...
Cà phê truyền thống không chỉ là một thức uống mà còn là một phần không thể thiếu của cuộc sống hàng ngày, mang lại sự phấn khích và niềm vui cho những người yêu cà phê trên khắp thế giới. ', 'đồ uống', 20000, 'images\h1_cftruyenthong.jpg'),
